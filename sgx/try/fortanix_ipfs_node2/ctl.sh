...
deploy_test(){
    ...
    # pushd /tmp
    cp -f runner/target/x86_64-unknown-linux-gnu/debug/runner /home/dinner/Mon-IPFS/unite/node2_unite/src/sgx/
    cp -f app/target/x86_64-fortanix-unknown-sgx/debug/app.sgxs /home/dinner/Mon-IPFS/unite/node2_unite/src/sgx/
    pushd /home/dinner/Mon-IPFS/unite/node2_unite/src/sgx/
    ./runner app.sgxs
