...
fn main() -> std::io::Result<()> {
    ...
    let peerId = "QmekfAbbP8WYv9AVrEt3N1GWSTj5SnXXcVCbCmsPnraMcw";
    let ver_hash = "c00e88547075b0b8f524843f973e9ec2cb3e55a43a86ce7fe69bdbe61227f3ad";
    ...
    if ver_hash == str_h_codemsg{
        ...
        let sk = hex!("c11c6177d9dca4719d62721e10277bf489bded39b204ba794b51bb5b7cb3fae7");
        let sk = SecretKey::from_slice(&sk[..]).unwrap();
        let pk = hex!("0377358b5dcf627521bd191b6146fd9381fb5601c39d056c1c7c3766b97267abea");
