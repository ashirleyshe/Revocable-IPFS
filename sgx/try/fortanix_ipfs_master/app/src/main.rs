...
fn main() -> std::io::Result<()> {
    ...
    let peerId = "Qmet6o1ojPFZaeifa7tFzkXryvUhrfLsnpJq2NHPBkk1Wu";
    let ver_hash = "4b36c761e78cd63bde3b69da2c64b9177fdd1eaf9ae968edfbe467feb50db14c";
    ...
    if ver_hash == str_h_codemsg{
        ...
        let sk = hex!("38df3e473ae6c8002ef142fe1a16401c39bd16048533c7b108a16cc2cc95e0c7");
        let sk = SecretKey::from_slice(&sk[..]).unwrap();
        let pk = hex!("031e97f7347e600c81f9342a2d4be74fd53ee72570376d1ce803b6349facc224f0");
