...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var rrrround, tmp, exp1, exp2, exp3, exp4, exp5, exp6, exp7, exp8, exp9, exp10, _loop_1, ub, js_uploadbase, js_sclogfile, concat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                rrrround = 4;
                ...
                _loop_1 = function () {
                    var execgen, procChildgen, accounts, spt_upload, spt_flag, ept_flag, roundth, round, apifcnt_1, _loop_2, filecorrect, _loop_3, state_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                procChildgen = new Promise(function (resolve, reject) {
                                    ...
                                    var yourscript = execgen('cd ../uploadFiles && rm * && cd .. && ./genfile.sh', function (error, stdout, stderr) { return __awaiter(void 0, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            // console.log('genfile');
                                            if (error !== null) {
                                                console.log("exec error: " + error);
                            ...
                            case 9:
                                ...
                                if (files.length % 20 > 0)
                                    round += 1;
                                _loop_2 = function () {
                                    var spt_ipfs, i, j, base64str, cmd, filehash, ept_ipfs;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                if (round != 0)
