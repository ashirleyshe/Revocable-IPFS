...
(async () => {
    ...
    if ((state.exe != web3.eth.defaultAccount && state.exe != 0x0000000000000000000000000000000000000000))
        ...
        let startpt_exp34 = new Date()
        console.log("~~~~~~~~ startpt_exp34 %o ~~~~~~~~~~~~~", startpt_exp34);
        ...
        if (flag == true) {
            ...
            console.log("~~~~~~~~ exp7(d) %o ~~~~~~~~~~~~~", +endpt_exp7 - +startpt_exp7);
            ...
            while (filecorrect == false) {
                ...
                if (set_done.events.Log_file.returnValues.succeed_or_not == true) {
                    let endpt_exp3 = new Date()
                    console.log("~~~~~~~~ endpt_exp3 %o ~~~~~~~~~~~~~", endpt_exp3);
                    console.log("~~~~~~~~ exp3 %o ~~~~~~~~~~~~~", +endpt_exp3 - +startpt_exp34);
                    ...
                    let endpt_exp4 = new Date()
                    console.log("~~~~~~~~ endpt_exp4 %o ~~~~~~~~~~~~~", endpt_exp4);
                    console.log("~~~~~~~~ exp4 %o ~~~~~~~~~~~~~", +endpt_exp4 - +startpt_exp34);
                    console.log("~~~~~~~~ exp6(d) %o ~~~~~~~~~~~~~", +endpt_exp4 - +endpt_exp3);
                    break;
                }
                else {
