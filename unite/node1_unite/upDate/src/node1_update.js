...
var ethereumUri = 'http://140.113.216.124:8546';
var web3 = new Web3();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                ...
                if (!(update == true)) return [3 /*break*/, 6];
                old_ts = Number(state.curts_index);
                return [3 /*break*/, 11];
            case 6: return [4 /*yield*/, async_get_nodestatus(Number(state.curts_index))];
            case 7:
                _a.sent();
                if (!(nstatus.iscorrect == 0)) return [3 /*break*/, 8];
                old_ts = Number(0);
                return [3 /*break*/, 11];
            case 8:
                if (!(nstatus.iscorrect == 1 && state.current_exe == web3.eth.defaultAccount)) return [3 /*break*/, 10];
                old_ts = Number(state.curts_index);
            ...
            case 10:
                ...
                return [3 /*break*/, 21];
            case 11:
                if (!(Number(old_ts) < Number(state.curts_index))) return [3 /*break*/, 18];
                console.log("changes has been detected------");
                if (!(state.current_exe != web3.eth.defaultAccount)) return [3 /*break*/, 15];
